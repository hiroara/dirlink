...
func cmdDataTemplatesDirlinkYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "cmd/data/templates/.dirlink.yaml", size: 230, mode: os.FileMode(420), modTime: time.Unix(1583159816, 0)}
